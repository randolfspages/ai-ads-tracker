    ...
    <header className={`py-4 ${isDarkMode ? "bg-gray-900 text-white" : "bg-white text-gray-900"} shadow-md transition-colors duration-300`}>
      <nav className="w-full mx-auto flex justify-between items-center px-4">
        ...
        <div className="text-xl font-bold">
          <Link href="/">AI SUPER PAC ads</Link>
        </div>
        ...
        <NavigationMenu className="hidden lg:flex">
          <NavigationMenuList className="flex space-x-8">
            <NavigationMenuItem>
              <Link href="/news" className={`${pathname === '/news' ? 'text-red-500 font-semibold' : ''} hover: text-gray-600`}>
                News
              </Link>
            </NavigationMenuItem>
            ...
            <NavigationMenuItem>
              <Link href="/about" className={`${pathname === '/about' ? 'text-red-500 font-semibold' : ''} hover: text-gray-600`}>
                About
              </Link>
            </NavigationMenuItem>
            <NavigationMenuItem>
